      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="text-left">
            ...
            >
              ...
              <motion.p
                ...
                transition={{ type: "spring", stiffness: 300, damping: 20 }}
              >
                Empowering healthcare professionals with AI-driven, real-time
                clinical workflows. Spend less time documenting and more time
                caring for patients.
              </motion.p>
              ...
              >
                <div className="flex -space-x-2">
                  {[1, 2, 3, 4].map((i) => (
                    <div
                      key={i}
                      className="w-8 h-8 rounded-full bg-gradient-to-br from-primary to-zinc-500 ring-2 ring-white dark:ring-zinc-900"
                    />
                  ))}
                </div>
        ...
        >
          {[
            {
              icon: Activity,
              text: "Real-time SOAP Generation",
              color: "blue",
              description: "AI-powered clinical documentation",
            },
            {
              icon: Shield,
              text: "Clinical Red-Flag Engine",
              color: "emerald",
              description: "Instant safety alerts",
            },
            {
              icon: Brain,
              text: "AI Hallucination Guard",
              color: "purple",
              description: "Verified medical accuracy",
            },
          ].map((feature, idx) => (
            <motion.div
              key={idx}
            ...
            >
              ...
              <div className="relative flex items-center gap-4 rounded-2xl bg-white/90 dark:bg-zinc-900/90 p-5 border border-zinc-200 dark:border-zinc-700 backdrop-blur-sm hover:border-primary/60 dark:hover:border-primary transition-all duration-300 shadow-xl hover:shadow-2xl">
                ...
                <motion.div
                  ...
                  style={{
                    background:
                      idx === 0 ? "#c0364c" : idx === 1 ? "#52525b" : "#3f3f46",
                  }}
                />
              </div>
            </motion.div>
