      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <h1 className="text-3xl font-bold text-zinc-900 dark:text-white">Smart Triage Agent</h1>
          </div>
          
          <div className="bg-white dark:bg-zinc-900 rounded-2xl p-8 shadow-sm border border-zinc-200 dark:border-zinc-800">
            <p className="text-zinc-600 dark:text-zinc-400 mb-8">
              The Triage Agent is ready to evaluate patient symptoms and suggest initial priority and test recommendations.
            </p>
            ...
            <div className="h-64 rounded-xl border-2 border-dashed border-zinc-200 dark:border-zinc-800 flex items-center justify-center">
              <span className="text-zinc-400 font-medium">Triage Interface Comming Soon</span>
            </div>
          </div>
        </motion.div>
      </div>
